...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  <a class="navbar-brand" href="#"> <img alt="" src="https://x-workz.in/static/media/Logo.cf195593dc1b3f921369.png" height="100px" width="100px"></a>
...
Please select Married:-Yes<input type="radio" id="Married" name="married" value="yes">  No<input type="radio" id="Married" name="married" value="No">
